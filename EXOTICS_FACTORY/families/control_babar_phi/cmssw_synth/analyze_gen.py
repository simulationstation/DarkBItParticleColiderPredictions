...
def main() -> None:
    parser = argparse.ArgumentParser(description="control_babar_phi GEN-only analyzer (SYNTHETIC)")
    parser.add_argument("--spec", default="EXOTICS_FACTORY/families/control_babar_phi/cmssw_synth/spec_cmssw.yaml")
    parser.add_argument("--input", default="control_babar_phi_GEN.root", help="Input GEN ROOT file")
    parser.add_argument(
        "--output-dir",
        default="EXOTICS_FACTORY/out/cmssw_synth/control_babar_phi",
