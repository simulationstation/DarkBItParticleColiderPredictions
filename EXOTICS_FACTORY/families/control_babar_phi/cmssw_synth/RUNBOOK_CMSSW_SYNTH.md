# CMSSW SYNTH Runbook: control_babar_phi
...
- Spec: `EXOTICS_FACTORY/families/control_babar_phi/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/control_babar_phi/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/control_babar_phi/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/control_babar_phi/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/control_babar_phi
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/control_babar_phi \
  --family control_babar_phi \
  --backend cmssw_synth \
  --run
```
