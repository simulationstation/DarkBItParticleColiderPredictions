...
def main() -> None:
    parser = argparse.ArgumentParser(description="strange_pcs GEN-only analyzer (SYNTHETIC)")
    parser.add_argument("--spec", default="EXOTICS_FACTORY/families/strange_pcs/cmssw_synth/spec_cmssw.yaml")
    parser.add_argument("--input", default="strange_pcs_GEN.root", help="Input GEN ROOT file")
    parser.add_argument(
        "--output-dir",
        default="EXOTICS_FACTORY/out/cmssw_synth/strange_pcs",
