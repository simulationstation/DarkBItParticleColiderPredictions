# CMSSW SYNTH Runbook: strange_pcs
...
- Spec: `EXOTICS_FACTORY/families/strange_pcs/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/strange_pcs/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/strange_pcs/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/strange_pcs/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/strange_pcs
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/strange_pcs \
  --family strange_pcs \
  --backend cmssw_synth \
  --run
```
