# CMSSW SYNTH Runbook: x3872_like
...
- Spec: `EXOTICS_FACTORY/families/x3872_like/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/x3872_like/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/x3872_like/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/x3872_like/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/x3872_like
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/x3872_like \
  --family x3872_like \
  --backend cmssw_synth \
  --run
```
