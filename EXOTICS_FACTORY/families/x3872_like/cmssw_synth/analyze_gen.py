...
def main() -> None:
    parser = argparse.ArgumentParser(description="x3872_like GEN-only analyzer (SYNTHETIC)")
    parser.add_argument("--spec", default="EXOTICS_FACTORY/families/x3872_like/cmssw_synth/spec_cmssw.yaml")
    parser.add_argument("--input", default="x3872_like_GEN.root", help="Input GEN ROOT file")
    parser.add_argument(
        "--output-dir",
        default="EXOTICS_FACTORY/out/cmssw_synth/x3872_like",
