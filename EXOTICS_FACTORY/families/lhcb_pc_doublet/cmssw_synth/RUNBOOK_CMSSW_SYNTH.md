# CMSSW SYNTH Runbook: lhcb_pc_doublet
...
- Spec: `EXOTICS_FACTORY/families/lhcb_pc_doublet/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/lhcb_pc_doublet/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/lhcb_pc_doublet/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/lhcb_pc_doublet/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/lhcb_pc_doublet
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/lhcb_pc_doublet \
  --family lhcb_pc_doublet \
  --backend cmssw_synth \
  --run
```
