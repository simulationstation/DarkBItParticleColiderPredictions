...
def main() -> None:
    parser = argparse.ArgumentParser(description="lhcb_pc_doublet GEN-only analyzer (SYNTHETIC)")
    parser.add_argument("--spec", default="EXOTICS_FACTORY/families/lhcb_pc_doublet/cmssw_synth/spec_cmssw.yaml")
    parser.add_argument("--input", default="lhcb_pc_doublet_GEN.root", help="Input GEN ROOT file")
    parser.add_argument(
        "--output-dir",
        default="EXOTICS_FACTORY/out/cmssw_synth/lhcb_pc_doublet",
