...
def main() -> None:
    parser = argparse.ArgumentParser(description="besiii_belle_isr_y GEN-only analyzer (SYNTHETIC)")
    parser.add_argument("--spec", default="EXOTICS_FACTORY/families/besiii_belle_isr_y/cmssw_synth/spec_cmssw.yaml")
    parser.add_argument("--input", default="besiii_belle_isr_y_GEN.root", help="Input GEN ROOT file")
    parser.add_argument(
        "--output-dir",
        default="EXOTICS_FACTORY/out/cmssw_synth/besiii_belle_isr_y",
