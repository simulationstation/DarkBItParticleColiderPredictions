# CMSSW SYNTH Runbook: besiii_belle_isr_y
...
- Spec: `EXOTICS_FACTORY/families/besiii_belle_isr_y/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/besiii_belle_isr_y/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/besiii_belle_isr_y/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/besiii_belle_isr_y/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/besiii_belle_isr_y
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/besiii_belle_isr_y \
  --family besiii_belle_isr_y \
  --backend cmssw_synth \
  --run
```
