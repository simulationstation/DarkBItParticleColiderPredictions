...
- Spec: `EXOTICS_FACTORY/families/belle_zb/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/belle_zb/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/belle_zb/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/belle_zb/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/belle_zb
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/belle_zb \
  --family belle_zb \
  --backend cmssw_synth \
  --run
```
