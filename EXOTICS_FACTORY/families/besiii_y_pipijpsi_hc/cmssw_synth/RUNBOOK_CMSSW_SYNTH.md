# CMSSW SYNTH Runbook: besiii_y_pipijpsi_hc
...
- Spec: `EXOTICS_FACTORY/families/besiii_y_pipijpsi_hc/cmssw_synth/spec_cmssw.yaml`
- Generator fragment: `EXOTICS_FACTORY/families/besiii_y_pipijpsi_hc/cmssw_synth/gen_fragment.py`
- Analyzer: `EXOTICS_FACTORY/families/besiii_y_pipijpsi_hc/cmssw_synth/analyze_gen.py`
- Docker runner: `EXOTICS_FACTORY/families/besiii_y_pipijpsi_hc/cmssw_synth/run_docker_genonly.sh`
...
```
EXOTICS_FACTORY/out/cmssw_synth/besiii_y_pipijpsi_hc
```
...
python EXOTICS_FACTORY/toolkit/rank1_harness.py \
  --input-dir EXOTICS_FACTORY/out/cmssw_synth/besiii_y_pipijpsi_hc \
  --family besiii_y_pipijpsi_hc \
  --backend cmssw_synth \
  --run
```
