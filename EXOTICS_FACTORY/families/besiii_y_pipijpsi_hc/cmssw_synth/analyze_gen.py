...
def main() -> None:
    parser = argparse.ArgumentParser(description="besiii_y_pipijpsi_hc GEN-only analyzer (SYNTHETIC)")
    parser.add_argument("--spec", default="EXOTICS_FACTORY/families/besiii_y_pipijpsi_hc/cmssw_synth/spec_cmssw.yaml")
    parser.add_argument("--input", default="besiii_y_pipijpsi_hc_GEN.root", help="Input GEN ROOT file")
    parser.add_argument(
        "--output-dir",
        default="EXOTICS_FACTORY/out/cmssw_synth/besiii_y_pipijpsi_hc",
